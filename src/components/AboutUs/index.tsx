  ...
  return (
    <Grid item container xs={12} justifyContent='center'>
      <div className={classes.root}>
        ...
        <h3>
          Praesent augue lacus, scelerisque sit amet volutpat at, placerat nec
          mi. Maecenas vel ex euismod, blandit diam ac, rhoncus lorem. Nullam ut
          dui eget mi varius facilisis quis semper augue. Morbi nec gravida
          velit
        </h3>
